...
const Mkcoordinator = () => {
  ...
  const tabs = ["Home", "Manage Contributions", "Manage Profie"];
    ...
    <div className="flex flex-col bg-white">
      <div className="ml-10 mr-10 max-w-screen-2xl px-6 text-base">
        <nav className="flex flex-row items-center justify-between p-3">
          ...
          <button
            className="ease rounded bg-red-500 px-4 py-2 text-xs font-bold uppercase text-white shadow outline-none transition-all duration-150 hover:shadow-md focus:outline-none active:bg-teal-600"
          ...
          >
            ...
            {index === 1 && (
              <div className="overflow-x-auto">
                <Header />
                <div className="mibg_blue relative mb-6 flex w-full min-w-0 flex-col break-words rounded-lg border-0 shadow-lgn-w-screen font-sans flex min-h-screen items-center justify-center overflow-hidden bg-gray-100 bg-gray-100">
